...
void setupFurniture() {
  ...
  // box2d.listenForCollisions(); This is a stub. The Customlistener() class
  // implements the listening methods.
  ...
  for (int i = 0; i < obstacle_count; i++) {
    obstacles.add(new Obstacle(random(60, width-60), random(100, height-200), random(35, 50), random(9, 10)));
  }
